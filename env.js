 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.ua-integration.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.ua-integration'; // ios bundle id
const PACKAGE = 'com.ua.integration'; // android package name
const NAME = 'UA Integration'; // app name
const EXPO_ACCOUNT_OWNER = 'ua-integration'; // expo account owner
const EAS_PROJECT_ID = '784fa82a-278d-4c89-b34b-62eb091c305b'; // eas project id
const SCHEME = 'ua-integration'; // app scheme
